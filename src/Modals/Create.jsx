    ...
    return (
        <div ref={modalRef} onClick={closeModal} className='fixed inset-0 flex justify-center items-center text-text bg-background bg-opacity-70 backdrop-blur-sm '>
            <form className="px-16 py-8 flex flex-col bg-container2 rounded-md text-left transition-all ">
                ...
                <textarea name='dreamDescription' rows={10} cols={20} className='p-1 rounded-md bg-container2 border-2 border-accent focus:outline-none focus:border-secondary'></textarea>
